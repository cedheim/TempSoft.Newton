...
{
    /// <summary>
    /// ActorEventListener is a class which listens to the eventsources registered and redirects the traces to a file
    ...
    internal class ActorEventListener : EventListener
    {
        ...
        {
            this._fileName = appName + DateTime.Now.ToString("yyyyMMddHHmmssffff");
        }
